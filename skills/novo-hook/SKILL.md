---
name: novo-hook
description: Cria um hook de dados PocketBase (CRUD) no padrão csc-web-kit: useCallback, requestKey:null, tratamento de erro em português, sem refetch após mutação. Use ao criar um hook para uma coleção.
---
